        ...
        <div class="container">
            <div class="header-top">
                <div class="pull-right social-icons">
                    ...
                    <a href="https://www.facebook.com/profile.php?id=100010909148406&fref=ts" target="_blank"><i class="fa fa-facebook"></i></a>
...
<section id="explore">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-3 col-sm-0">  
                <iframe width="560" height="315" src="https://www.youtube.com/embed/BiLDmUx60cs" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="col-md-8 col-md-offset-2 col-sm-0">  
                
                <div id="cp_widget_62f2b278-9583-4823-a8a8-fe13b5979427">...</div><script type="text/javascript">
var cpo = []; cpo["_object"] ="cp_widget_62f2b278-9583-4823-a8a8-fe13b5979427"; cpo["_fid"] = "A0JACj9-n67H";
var _cpmp = _cpmp || []; _cpmp.push(cpo);
(function() { var cp = document.createElement("script"); cp.type = "text/javascript";
cp.async = true; cp.src = "//www.cincopa.com/media-platform/runtime/libasync.js";
var c = document.getElementsByTagName("script")[0];
c.parentNode.insertBefore(cp, c); })(); </script><noscript>Powered by Cincopa <a href='http://www.cincopa.com/media-platform/podcast-player'>Podcast Hosting</a> for Business solution.<span>New Gallery 2016/6/3</span><span>Love Two Times</span><span>Time Machine</span><span>Up Around the Bend</span></noscript>
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-sm-4">
                                    <div class="single-event">
                                        ...
                                        <h4>99/99/9999 99:99</h4>
                                        <h5>Entrada R$25,00 </h5>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="single-event">
...
<section id="about">
    ...
    <div class="about-content">
        <h2>Sobre a banda</h2>
        <p>
            <i>“Um som consistente, robusto e impactante”.</i><br />
            <br />

            Assim pode ser descrita a banda ROCKA ´N´ VOO, de Belo

            Horizonte - MG.

            Formada por Bruno Bethonico (guitarra e vocais), Cris

            Lacerda (vocal principal), Jean Leão (bateria e vocais) e

            Marco Farnezi (baixo e vocais), a banda traz em seu

            repertório uma seleção de clássicos do rock, especialmente

            dos anos 70, tendo também como objetivo a criação de

            músicas próprias que ecoem a alma do rock de antes, mas

            solidifiquem um novo som.
        </p>
        <h2>Influências:</h2>

        <p>
            No repertório atual de ROCKA ´N´ VOO você poderá

            conferir: Jefferson Airplane, The Rolling Stones, Casa das

            Máquinas, Raul Seixas, Black Sabbath, The Doors,

            Creedence Clearwater Revival, Deep Purple, dentre
            ...
            <div class="row">
                <div class="col-sm-10">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <ul>
                                <li><a href="http://www.leyline.com" target="_blank"><img class="img-responsive" src="images/sponsor/sponsor1.png" alt=""></a></li>
            ...
            <div class="row">
                <div class="col-sm-3 col-sm-offset-4">
                    <div class="contact-text">
                        <h3>Contatos</h3>
                        <address>
                            E-mail: promo@rockanvoo.com.br<br>
                            Phone: +55 (31) 99136 3177<br>                            
                        </address>
                    </div>
...
<footer id="footer">
    <div class="container">
        <div class="text-center">
            <p> Copyright  &copy;2016 Marco Farnezi <br>All Rights Reserved. <br> </p>
        </div>
    </div>
</footer>
<!--/#footer-->
